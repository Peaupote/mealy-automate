...
\begin{center}
  \begin{figure}[h]
    ...
    \caption{Contre exemple à une génélisation du théorème \ref{thm:K}, aka Les 4 fantastiques\label{fig:fantastiques}}
  \end{figure}
\end{center}
...
\begin{definition}
  Un automate est \textbf{\textit{fantastique}} s'il n'est pas $\mathfrak{md}$-trivial et $\mathfrak{mdc}$-trivial.
\end{definition}

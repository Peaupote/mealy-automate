...
Les 3 problèmes importants\footnote{ref} de théorie des groupes sont le problème du mot, être capable de décider si un mot est l'élement neutre ; le problème de conjugaison, être capable de décider si un élément est le conjugé d'un autre; et le problème de finitude, être capable de décider si un groupe est fini ou non. C'est un problème difficile, indécidable en général pour les semi-groupes d'automates. Picantin et Klimann~\cite{DBLP:journals/corr/abs-1105-4725} on proposé la $\mathfrak{md}$-réduction (définition \ref{def:md-red}), une procédure alternant minimisation et dualisation de l'automate pour décider de la finitude du groupe qu'il engendre et Klimann~\cite{Klimann13} a réussi à montrer que les groupes engendrés par des automates biréversibles à deux états ou deux lettres sont finis si et seulement si l'automate est $\mathfrak{md}$-trivial.

...
\begin{figure}[h!]
  ...
  \caption{$\mathfrak{md}$-réduction de l'automate $\mathcal{B}$.\label{fid:md-red-ex}}
\end{figure}
...
\begin{definition}
  ...
  La $\mathfrak{mdc}$-réduction consiste à répéter la $\mathfrak{md}$-réduction de l'automate et de ses conjugués jusqu'à trouver des paires $\mathfrak{mdc}$-réduite.
\end{definition}
...
\end{center}
  \caption{$\mathfrak{mdc}$-réduction du deuxième contre-exemple. Il est conjugé avec l'automate $\mathcal{B}$ de la figure \ref{fid:md-red-ex} qui est $\mathfrak{md}$-trvial}
\end{figure}

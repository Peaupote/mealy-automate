...
\begin{definition}
  Si une machine de Mealy est réversible, alors on peut construire sont \textbf{\textir{dual}}, noté $\mathfrak{d}\mathcal{M}$, en remplacant les flèches $p\overset{x|y}{\longrightarrow}q$ par $x\overset{p|q}{\longrightarrow}y$.
\end{definition}

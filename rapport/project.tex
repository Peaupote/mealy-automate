...
La propriétés \ref{prop:clot_birev} nous permet de connaître la structure des facteurs d'un automate biréversible, aidant ainsi à l'implémentation de l'algorithme suivant.

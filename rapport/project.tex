...
\begin{center}
  \begin{figure}[h]
    \label{fig:example}
    ====> INSERER MACHINE TIKZ <====
    \caption{une machine de Mealy}
  \end{figure}
\end{center}
...
\begin{center}
  \begin{figure}[h]
    ====> INSERER DIAGRAMME EN CROIX TIKZ <====
    \caption{action de la machine \ref{fig:example} sur le mot xxxx}
  \end{figure}
\end{center}

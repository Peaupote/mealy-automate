...
\begin{definition}
  ...
  Le \textbf{minimisé} de $\mathcal{A}$ est l'automate $\mathfrak{m}(\mathcal{A})=\left(\mathcal{Q}/\equiv, \Sigma, \bar{\delta}, \bar{\rho}\right)$, où pour tout $p\in\mathcal{Q}$ et $x\in\Sigma$, $\bar{\delta}_x(\bar{p}) = \bar{\delta_x(p)}$ et $\bar{\rho}_{\bar{p}} =  \rho_p$.
\end{definition}
...
\begin{prop}{\cite{DBLP:journals/corr/abs-1105-4725}}
  ...
  Soit $\mathcal{A}$ un automate de Mealy. Si $\mathfrak{m}A$ engendre un groupe fini, alors $\mathcal{A}$ engendre un groupe fini.
\end{prop}
...
\begin{prop}
  ...
  Tout automate de Mealy dont le $\mathfrak{md}$-réduit engendre un groupe fini engendre un groupe fini.
\end{prop}
...
Cette conjecture est fausse en général. Il semble pourtant que dans la classe particulière des automates biréversibles, la $\mathfrak{md}$-réduction est efficace.

\begin{conj}
  \label{conj:birev-md}
  Un automate de Mealy biréversible engendre un groupe fini si et seulement si son $\mathfrak{md}$-réduit engendre un groupe fini.
\end{conj}
...
\begin{conj}
  ...
  Un automate de Mealy biréversible engendre un groupe fini si et seulement si son $\mathfrak{mdc}$-réduit engendre un groupe fini.
\end{conj}
...
\begin{prop}
  Tout automate de Mealy dont le $\mathfrak{mdc}$-réduit engendre un groupe fini engendre un groupe fini.
\end{prop}
